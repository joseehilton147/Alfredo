...
- When executing the tasks of a spec, before marking the main task as completed, review whether all the subtasks have been implemented correctly, if so, mark as completed, if not, adjust whatever is necessary before marking as completed.
